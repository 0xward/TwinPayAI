...
import { CheckCircle2, XCircle, AlertCircle, Sparkles, ShieldCheck, X } from "lucide-react";
...
interface DecisionCardProps {
  ...
  onExecute: () => void;
  isPending: boolean;
  onCancel?: () => void;   // ✅ prop untuk menutup kartu
}

export default function DecisionCard({ decision, onExecute, isPending, onCancel }: DecisionCardProps) {
  ...
  return (
    <AnimatePresence>
      <motion.section 
        ...
        className="bg-surface border border-line rounded-2xl overflow-hidden shadow-2xl flex flex-col relative"
      >
